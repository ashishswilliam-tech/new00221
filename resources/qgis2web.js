...
map.getView().fit([8530760.675265, 1038439.748574, 8538722.808609, 1044098.391384], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">AARANMULA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (34 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is a tendative work of Ashish';
            }
